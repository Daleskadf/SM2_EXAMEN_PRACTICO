...
import './login_history_screen.dart'; // <-- IMPORTA la pantalla del historial
...
class _ConductorDashboardState extends State<ConductorDashboard> {
  ...
  // Nueva función para abrir la pantalla de historial de inicios de sesión
  void _verLoginHistory(BuildContext context) {
    Navigator.push(
      context,
        ...
        child: SafeArea(
          child: Column(
            ...
            children: [
              ...
              // NUEVO: Acceso al historial de INICIOS DE SESIÓN
              ListTile(
                leading: const Icon(Icons.history_toggle_off),
                title: const Text('Historial de Inicios de Sesión'),
                onTap: () {
                  Navigator.pop(context);
                  _verLoginHistory(context);
                },
              ),
